...
export const integrationsData: Record<string, ATSIntegration> = {
  ...
  ashby: {
    ...
    seo: {
      ...
      description: "CallPilot's AI voice calls screen every Ashby applicant the moment they apply, so hiring teams never let a good one go quiet. Two-way native sync.",
      ogTitle: "AI Screening Calls for Ashby | CallPilot",
      ogDescription: "Human-like AI screening calls with instant traffic-light scoring, built for fast-moving Ashby hiring teams. Screen every applicant automatically and sync results in real-time.",
      twitterTitle: "AI Screening Calls for Ashby | CallPilot",
      twitterDescription: "CallPilot's AI voice calls screen every Ashby applicant the moment they apply, so hiring teams never let a good one go quiet.",
      schemaDescription: "AI voice screening calls with instant traffic-light scoring, integrated directly with Ashby.",
    },
    hero: {
    ...
    callout: {
      title: "Ashby Sync, Live Both Ways",
      desc: "Every call outcome, document, and status change writes straight to the Ashby record the moment it happens. No exports, no re-keying, no lag between CallPilot and your ATS.",
      badgeText: "Ashby: LIVE",
    },
    pricingFeatures: ["Ashby sync included"],
    faqs: [
      {
        question: "Is the Ashby integration actually live?",
        answer: "Yes. It's live now, applicant status and documents sync into the Ashby record automatically as soon as CallPilot has them.",
      },
      {
        question: "How does the traffic-light scoring work?",
        answer: "Every screening call is scored amber, green, or red against the job brief the moment it ends. Amber is qualified and awaiting documents, green is documents received, red is unsuccessful. No recruiter has to sit and mark it manually.",
    ...
    finalCta: {
      h2: "Ready to Put Ashby Screening on Autopilot?",
      lead: "Every applicant called, scored, and actioned the moment they apply, no matter the hour. No backlog, no lost paperwork, no missed applicants.",
      primaryText: "Get Connected",
      primaryUrl: "https://www.callpilot.pro/?utm_source=integrations&utm_medium=cta&utm_campaign=ashby&utm_content=get-connected",
      secondaryText: "Arrange a Call",
      secondaryUrl: "https://www.callpilot.pro/?utm_source=integrations&utm_medium=cta&utm_campaign=ashby&utm_content=arrange-a-call",
    },
  },
